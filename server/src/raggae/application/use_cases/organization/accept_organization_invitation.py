...
class AcceptOrganizationInvitation:
    """Use Case: Accept organization invitation from token hash."""
    ...
    async def execute(self, token_hash: str, user_id: UUID) -> OrganizationMemberDTO:
        invitation = await self._organization_invitation_repository.find_by_token_hash(token_hash)
