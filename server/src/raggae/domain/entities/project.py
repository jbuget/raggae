...
class Project:
    ...
    overrides_models_from_org: bool = True
    overrides_indexing_from_org: bool = True
    overrides_retrieval_from_org: bool = True
    overrides_reranking_from_org: bool = True
    overrides_chat_history_from_org: bool = True
