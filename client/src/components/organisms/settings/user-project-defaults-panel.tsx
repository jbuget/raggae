    ...
    <Card className="space-y-8 p-5">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="user-embeddingBackend">{tSettings("models.embeddingBackendLabel")}</Label>
          <select
            id="user-embeddingBackend"
        ...
        {effectiveEmbeddingBackend ? (
          <>
            <div className="space-y-2">
              <Label htmlFor="user-embeddingCredentialId">{tSettings("models.embeddingApiKeyLabel")}</Label>
              <select
                id="user-embeddingCredentialId"
            ...
            <div className="space-y-2">
              <Label htmlFor="user-embeddingModel">{tSettings("models.embeddingModelLabel")}</Label>
              <select
                id="user-embeddingModel"
        ...
        <div className="space-y-2">
          <Label htmlFor="user-llmBackend">{tSettings("models.llmBackendLabel")}</Label>
          <select
            id="user-llmBackend"
        ...
        {effectiveLlmBackend ? (
          <>
            <div className="space-y-2">
              <Label htmlFor="user-llmCredentialId">{tSettings("models.llmApiKeyLabel")}</Label>
              <select
                id="user-llmCredentialId"
            ...
            <div className="space-y-2">
              <Label htmlFor="user-llmModel">{tSettings("models.llmModelLabel")}</Label>
              <select
                id="user-llmModel"
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="user-chunkingStrategy">{tSettings("knowledgeIndexing.chunkingLabel")}</Label>
          <select
            id="user-chunkingStrategy"
        ...
        <div className="flex items-center gap-2">
          <Switch
            id="user-parentChildChunking"
            checked={effectiveParentChildChunking}
            onCheckedChange={setParentChildChunking}
          />
          <Label htmlFor="user-parentChildChunking">{tSettings("knowledgeIndexing.parentChildLabel")}</Label>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="user-retrievalStrategy">{tSettings("contextRetrieval.searchTypeLabel")}</Label>
          <select
            id="user-retrievalStrategy"
        ...
        <div className="space-y-2">
          <Label htmlFor="user-retrievalTopK">{tSettings("contextRetrieval.topKLabel")}</Label>
          <Input
            id="user-retrievalTopK"
            type="number"
            min={1}
            max={40}
        ...
        <div className="space-y-2">
          <Label htmlFor="user-retrievalMinScore">{tSettings("contextRetrieval.minScoreLabel")}</Label>
          <Input
            id="user-retrievalMinScore"
            type="number"
            min={0}
            max={1}
            step={0.05}
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <Switch
            id="user-rerankingEnabled"
            checked={effectiveRerankingEnabled}
            onCheckedChange={setRerankingEnabled}
          />
          <Label htmlFor="user-rerankingEnabled">{tSettings("contextAugmentation.rerankingLabel")}</Label>
        </div>
        {effectiveRerankingEnabled && (
          <>
            <div className="space-y-2">
              <Label htmlFor="user-rerankerBackend">{tSettings("contextAugmentation.rerankerBackendLabel")}</Label>
              <select
                id="user-rerankerBackend"
            ...
            <div className="space-y-2">
              <Label htmlFor="user-rerankerModel">{tSettings("contextAugmentation.rerankerModelLabel")}</Label>
              <select
                id="user-rerankerModel"
            ...
            <div className="space-y-2">
              <Label htmlFor="user-rerankerCandidateMultiplier">{tSettings("contextAugmentation.candidateMultiplierLabel")}</Label>
              <Input
                id="user-rerankerCandidateMultiplier"
                type="number"
                min={1}
                max={10}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="user-chatHistoryWindowSize">{tSettings("answerGeneration.chatHistoryWindowLabel")}</Label>
          <Input
            id="user-chatHistoryWindowSize"
            type="number"
            min={1}
            max={40}
        ...
        <div className="space-y-2">
          <Label htmlFor="user-chatHistoryMaxChars">{tSettings("answerGeneration.chatHistoryMaxCharsLabel")}</Label>
          <Input
            id="user-chatHistoryMaxChars"
            type="number"
            min={128}
            max={16000}
